...
or the Media Browser to allow them to mark a publish with a Status. You can see more information on that here: [Slack - Approvals](/prism/slack/slack/approvals)
