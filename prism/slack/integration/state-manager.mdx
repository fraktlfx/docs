...
You can also notify a user when content is on the way to be published. You can view what that will look like here: [Slack - Notifications](/prism/slack/slack/notifications) 
...
[Slack - Notifications](/prism/slack/slack/notifications) 

### Status
If the Approvals options are enabled, Status will allow the artist to send their post with Approvals buttons. You can find more information on that here: [Slack - Approvals](/prism/slack/slack/approvals)
