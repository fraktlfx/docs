...
<Accordion title="Can I mix licensed and non-licensed versions of Prism+?">
    Yes. There is currently no difference between the versions for the Slack plugin. Though you should see this [Installation - Recommendations](/prism/slack/introduction/installation#recommendations) before moving forward with this setup.
</Accordion>
